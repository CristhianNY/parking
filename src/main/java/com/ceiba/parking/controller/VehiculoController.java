...
import com.ceiba.parking.excepciones.NotFoundVehiculoException;
...
public class VehiculoController {
	...
	@ResponseBody
	public ResponseEntity<List<Vehiculo>> obtenerVehiculos()throws NotFoundVehiculoException {
		...
		if (vehiculos.isEmpty()) {
			...
			throw new NotFoundVehiculoException("vehiculos"+vehiculos);
		}
	...
	public ResponseEntity<Vehiculo> obtenerVehiculoPorPlaca(@PathVariable("placa") String placa)  throws NotFoundVehiculoPlacaException{
		if (placa == null) {
		...
		if (vehiculo == null) {
			throw new NotFoundVehiculoPlacaException("Placa:"+vehiculo);
		}
	...
	public ResponseEntity<Vehiculo> actualizarVehiculo(@PathVariable("placa") String placa,
	...
	public ResponseEntity<?> guardarVehiculo(@RequestBody Vehiculo vehiculo,
		...
		headers.setLocation(
				uriComponentsBuilder.path("/v1/vehiculos/{id}").buildAndExpand(vehiculo2.getIdvehiculo()).toUri());
	...
	public String index() {
		...
		return "Welcom to parking ceiba";
